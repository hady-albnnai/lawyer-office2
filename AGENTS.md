...
- **FUNCTIONAL_TESTING_PLAN.md**: خطة اختبارات فعلية شاملة (68 اختبار تفاعلي)
- **FUNCTIONAL_TESTING_TRACKER.md**: ملف تتبع نتائج الاختبارات الفعلية
- **TESTING_PLAN.md**: خطة الاختبار الأصلية (تحليل كودي)
- **TESTING_TRACKER.md**: ملف تتبع الاختبار الأصلي (تحليل كودي)
- **FINAL_TESTING_REPORT.md**: تقرير الاختبار النهائي (تحليل كودي)
- **TESTING_UPDATE_STRATEGY.md**: استراتيجية التحديث للاختبارات

### 🚨 مشكلة معروفة: حفظ الوكالة
**التاريخ:** 30 يوليو 2026  
**الحالة:** تحتاج للتحقق والاختبار الفعلي

**الوصف:**
- أشار المستخدم إلى وجود مشكلة في حفظ الوكالة
- لم يتم تحديد نوع المشكلة بالتفصيل
- تحتاج لاختبار تفاعلي في FUNCTIONAL_TESTING_PLAN.md (اختبار 42)

**خطوات التحقق المقترحة:**
1. اختبار إنشاء وكالة جديدة بناءً على FUNCTIONAL_TESTING_PLAN.md
2. التحقق من حفظ جميع البيانات بشكل صحيح
3. التحقق من رفع وحفظ صورة الوكالة
4. التحقق من الربط بالموكل والوكيل
5. تسجيل أي أخطاء أو رسائل تظهر
...
### الفرق بين نوعي الاختبار:

#### 1. الاختبار الكودي (TESTING_PLAN.md):
- **الهدف:** تحليل البنية التقنية والكود
- **الطريقة:** قراءة وفحص الملفات البرمجية
- **النتيجة:** فهم البنية والوظائف المتاحة
- **الاستخدام:** لفهم النظام وإدارة الكود
- **الوضع الحالي:** مكتمل 100% (68/68)

#### 2. الاختبار الفعلي (FUNCTIONAL_TESTING_PLAN.md):
- **الهدف:** اختبار الوظائف تفاعلياً مع التطبيق
- **الطريقة:** استخدام التطبيق وتنفيذ الإجراءات
- **النتيجة:** التأكد من العمل الفعلي للوظائف
- **الاستخدام:** لضمان جودة الإصدار النهائي
- **الوضع الحالي:** لم يبدأ (0/68)

### كيفية استخدام FUNCTIONAL_TESTING_PLAN.md:

1. **الاستعداد:**
   - تأكد من أن التطبيق يعمل
   - قم بإنشاء بيانات اختبار
   - جهز ملفات اختبار (صور، PDF، Word)

2. **التنفيذ:**
   - افتح FUNCTIONAL_TESTING_PLAN.md
   - ابدأ بالاختبار رقم 1
   - نفذ الخطوات المحددة
   - دوّن النتيجة في FUNCTIONAL_TESTING_TRACKER.md

3. **التسجيل:**
   - لكل اختبار، حدد الحالة (✅ نجح / ❌ فشل)
   - أضف ملاحظات مفصلة
   - سجل التاريخ والمختبر
   - التقط لقطات عند المشاكل

4. **التركيز على المشكلة:**
   - ابدأ مباشرة باختبار 42 (إنشاء وكالة جديدة)
   - هذا الاختبار حاسم لحل مشكلة الوكالة المذكورة
   - دوّن أي أخطاء بالتفصيل

### مثال على التسجيل في FUNCTIONAL_TESTING_TRACKER.md:

```
### اختبار 42: إنشاء وكالة جديدة (اختبار حاسم)
**الحالة:** ❌ فشل
**النتيجة:** لم يتم حفظ الوكالة
**الملاحظات:** عند الضغط على زر الحفظ، ظهر خطأ: "Database error: foreign key constraint failed"
**التاريخ:** 30 يوليو 2026
**المختبر:** [اسمك]
```
...
1. **الأولوية القصوى:**
   - اختبار 42: إنشاء وكالة جديدة (لحل المشكلة المذكورة)

2. **الأولوية العالية:**
   - اختبار 1-8: المصادقة والأمان (أساس النظام)
   - اختبار 12: إنشاء قضية جديدة (وظيفة أساسية)

3. **الأولوية المتوسطة:**
   - اختبار 18: إنشاء شركة جديدة
   - اختبار 22: إنشاء عقد جديد
   - اختبار 25-29: إدارة المستندات

4. **الأولوية المنخفضة:**
   - اختبار 64-68: أداء التطبيق (اختبارات نهائية)

### بعد اكتمال الاختبار:

1. **مراجعة النتائج:**
   - راجع FUNCTIONAL_TESTING_TRACKER.md
   - حدد الاختبارات الفاشلة
   - صنف المشاكل حسب الخطورة

2. **إصلاح المشاكل:**
   - ابدأ بالأخطاء الحرجة
   - أصلح المشاكل بالترتيب
