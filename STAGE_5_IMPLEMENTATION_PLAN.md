...
تنفيذ نظام إدارة الدعاوى بشكل كامل بما يتوافق مع:
...
- [x] **5.3.1** إنشاء `lib/presentation/screens/cases/create_case_wizard.dart`
  - **الخطوة 1:** بيانات الموكل
  - **الخطوة 2:** بيانات الوكالة
  - **الخطوة 3:** التصنيف (نوع الدعوى، المحكمة)
  - **الخطوة 4:** البيانات الأساسية
  - **الخطوة 5:** الموضوع (وصف الدعوى)
  - **الخطوة 6:** الخصم (المدعى عليه)
  - **الخطوة 7:** المرفقات (المستندات)
  - **الخطوة 8:** الموعد القادم
...
##### تبويبات case_detail_screen.dart
