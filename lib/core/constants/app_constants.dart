...
class AppConstants {
  ...
  // ---------------------------------------------------------------------------
  // المحافظات السورية (تُستخدم كاسم للمحكمة)
  // ---------------------------------------------------------------------------
  /// اسم المحكمة = المحافظة فقط. الدرجة (صلح/بداية/استئناف/نقض) شأن
  /// مستقل يُدار عبر جدول المراحل القضائية JudicialPhases، ولا تُدمج
  /// في التسمية. رقم الغرفة يُحفظ في عمود chamber_number.
  ...
  /// الغرف المعتادة في محاكم المحافظات: من 1 إلى 16.
  /// يُسمح للمستخدم بإدخال رقم أكبر (17، 18...) عند استحداث غرف جديدة.
  static const int minChamberNumber = 1;
  static const int defaultMaxChamberNumber = 16;

  // ---------------------------------------------------------------------------
  // المرفقات: الصيغ المسموحة وحدود الحجم
  // ---------------------------------------------------------------------------
  /// الصيغ التي يستطيع التطبيق تخزينها وفتحها. أي صيغة خارجها تُرفض
  /// عند الاختيار مع رسالة توضّح المسموح، حتى لا يُرفع ملف لا يُقرأ.
  static const List<String> allowedAttachmentExtensions = [
    // مستندات
    'pdf',
    // Word ومعالجات النصوص
    'doc', 'docx', 'rtf',
    // صور
  ...
  /// الصيغ التي يعرضها التطبيق داخلياً دون تطبيق خارجي.
  static const List<String> internallyPreviewableExtensions = [
    'pdf', 'jpg', 'jpeg', 'png', 'webp',
  ];

  /// الحد الأقصى لحجم المرفق الواحد (50 ميجابايت).
  static const int maxAttachmentSizeBytes = 50 * 1024 * 1024;
}
