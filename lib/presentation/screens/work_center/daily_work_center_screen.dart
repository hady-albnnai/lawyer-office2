...
import 'deficiency_resolver_dialog.dart';
  ...
  if (includeAttention) {
    ...
    for (final d in deficiencies.take(8)) {
      ...
      items.add(_WorkItem(
        ...
        entityRoute: switch (d.entityType) {
          0 => '/cases/${d.entityId}',
          1 => '/contracts/${d.entityId}',
          2 => '/companies/${d.entityId}',
          3 => '/procedures/${d.entityId}',
          4 => '/persons/${d.entityId}',
          5 => '/poa/${d.entityId}',
          _ => '',
        },
        assignedTo: '',
        ...
        onResult: () => showDialog<void>(
          context: context,
          builder: (_) => DeficiencyResolverDialog(deficiency: d),
        ),
      ));
    }
  }
