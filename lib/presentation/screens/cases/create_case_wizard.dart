  ...
  Future<void> _submitCase() async {
    ...
    try {
      ...
      await ref.read(auditServiceProvider).log(
        ...
        description: 'إنشاء دعوى جديدة عبر الويزارد',
        after: {
          ...
          'opponentId': _selectedOpponentId,
          'poaId': _selectedPoaId,
          'courtKindId': _court.kindId,
          'chamberNumber': _court.chamberNumber,
          'baseNumber': _baseNumberController.text.trim(),
          'baseYear': _baseYearController.text.trim(),
          'isUrgent': _isUrgent,
          'attachmentsCount': _attachmentPaths.length,
          'source': widget.archiveContext != null ? 'archive' : 'new_work',
          if (widget.archiveContext != null) 'archiveSummary': widget.archiveContext!.summary,
          if (widget.archiveContext != null) 'archiveStatus': widget.archiveContext!.status,
          if (widget.archiveContext != null) 'archivePoaType': widget.archiveContext!.poaType,
        },
        severity: 'info',
      );
